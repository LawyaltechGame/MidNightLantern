          ...
          <div className="flex-1">
            ...
            <div className="flex justify-between items-center mt-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-cyan-500 hover:bg-cyan-600 disabled:bg-slate-600 disabled:cursor-not-allowed text-white rounded-full font-medium transition-colors"
              >
